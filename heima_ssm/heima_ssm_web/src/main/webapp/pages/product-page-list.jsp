        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共<div>${pageInfo.pages}</div> 页，共<div>${pageInfo.total}</div> 条数据。 每页
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                           ...
                           <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                               <li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}">1</a>${pageNum}</li>
                           </c:forEach>
